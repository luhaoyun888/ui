...
function RBACView({ pluginId: _pluginId }: { pluginId: string }) {
  ...
  return (
    <div className="flex flex-col gap-6 min-h-[850px]">
                ...
                <div className="glass-card rounded-[3rem] overflow-hidden border-white/5 shadow-2xl">
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full text-left border-collapse">
                      <thead>
                        <tr className="bg-[#0f172a] text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">
...
const StatCard: React.FC<{ label: string, value: number, icon: any, color: 'indigo' | 'teal' | 'rose' | 'emerald' }> = ({ label, value, icon: Icon, color }) => {
  ...
  return (
    <div className={cn(
      "glass-card rounded-[2.5rem] p-8 border bg-gradient-to-br to-transparent transition-all hover:scale-[1.02] cursor-default group", 
      colors[color]
    )}>
      <div className="flex items-center justify-between mb-6">

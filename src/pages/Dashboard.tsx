...
import { ShieldCheck, Cpu, Zap, Activity as ActivityIcon, ShieldAlert, Key, ArrowRight } from 'lucide-react';
...
export default function Dashboard() {
  ...
  const stats = [
    { label: 'Uptime', value: '99.98%', trend: 'Stable', icon: ActivityIcon },
  ...
  return (
    <div className="space-y-8 pb-10" ref={containerRef} onMouseMove={handleMouseMove}>
      {/* Hero Section */}
      <section className="glass-card rounded-[2.5rem] p-10 relative overflow-hidden group hover-glow spotlight-card">
        <div className="absolute -top-24 -right-24 w-96 h-96 bg-indigo-500/10 blur-[120px] rounded-full group-hover:bg-indigo-500/20 transition-all duration-1000 animate-pulse"></div>
        <div className="absolute -bottom-24 -left-24 w-64 h-64 bg-pink-500/5 blur-[100px] rounded-full group-hover:bg-pink-500/10 transition-all duration-1000"></div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat, i) => (
          <motion.div
            ...
            className="p-8 glass-panel rounded-[2rem] group hover:bg-white/10 transition-all cursor-default spotlight-card"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="p-10 glass-card rounded-[3rem] spotlight-card">
        ...
        {/* Steps Card */}
        <div className="p-10 glass-card rounded-[3rem] h-fit spotlight-card">
            ...
            <div className="relative pl-10 border-l border-white/10 space-y-12 pb-2">
              {[
                ...
                <div key={i} className="relative">
                  <div className="absolute -left-[51px] top-0 w-5 h-5 bg-[#030712] border-4 border-indigo-500 rounded-full shadow-[0_0_15px_rgba(99,102,241,0.5)] z-10" />
